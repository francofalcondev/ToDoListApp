...
export const TaskItem = ({task}: TaskItemProps) => {
    ...
    return (
        <View style={styles.containerTaskItemMain}>
            <BouncyCheckbox size={20} iconStyle={{marginTop: 5}}  isChecked={task.completed} innerIconStyle={{ borderWidth: 2 }} fillColor="gray"  text={task.title} textStyle={{color: 'black', fontSize: 20}}/>
